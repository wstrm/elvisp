        ...
        ipv6.addBit(lastIP, function(err, address) {
          ...
          ipv6.inRange(address, range, function(err, result) {
            ...
            ipv6.toString(address, function(err, stringAddress) {
              ...
              _this.cjdns.IpTunnel_allowConnection(data.pubkey, _this.config.iptunnel.prefix, stringAddress, function(err, data) {
                if (err) {
                  throw new Error(err);
                }
                ...
                _this.cjdns.IpTunnel_listConnections(function(err, data) {
